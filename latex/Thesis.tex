...
\begin{figure}[H]
    \centering
    \begin{subfigure}{0.32\textwidth} \centering \includegraphics[width=\textwidth]{Images/fdtd_snapshots/experiment_1_swr/swr_convergence.png} \caption{Smooth, $\gamma=0$, $\nu=0$} \end{subfigure}
    \hfill
    \begin{subfigure}{0.32\textwidth} \centering \includegraphics[width=\textwidth]{Images/fdtd_snapshots/experiment_3_swr/swr_convergence.png} \caption{Smooth, $\gamma=0.5$, $\nu=0.005$} \end{subfigure}
    \hfill
    \begin{subfigure}{0.32\textwidth} \centering \includegraphics[width=\textwidth]{Images/fdtd_snapshots/experiment_5_swr/swr_convergence.png} \caption{Pulse, $\gamma=0$, $\nu=0$} \end{subfigure} \\
    \vspace{0.5cm}
    \begin{subfigure}{0.32\textwidth} \centering \includegraphics[width=\textwidth]{Images/fdtd_snapshots/experiment_2_swr/swr_convergence.png} \caption{Non-smooth, $\gamma=0$, $\nu=0$} \end{subfigure}
    \hfill
    \begin{subfigure}{0.32\textwidth} \centering \includegraphics[width=\textwidth]{Images/fdtd_snapshots/experiment_4_swr/swr_convergence.png} \caption{Non-smooth, $\gamma=0.5$, $\nu=0.005$} \end{subfigure}
    \hfill
    \begin{subfigure}{0.32\textwidth} \centering \includegraphics[width=\textwidth]{Images/fdtd_snapshots/experiment_6_swr/swr_convergence.png} \caption{Pulse, $\gamma=0$, $\nu=0$} \end{subfigure}
...
\begin{figure}[H]
    \centering
    \begin{subfigure}{0.32\textwidth} \centering \includegraphics[width=\textwidth]{Images/pstd_snapshots/experiment_1_order/nodal_error_vs_monolithic_order.png} \caption{Smooth, $\gamma=0$, $\nu=0$} \end{subfigure}
    \hfill
    \begin{subfigure}{0.32\textwidth} \centering \includegraphics[width=\textwidth]{Images/pstd_snapshots/experiment_3_order/nodal_error_vs_monolithic_order.png} \caption{Smooth, $\gamma=0.5$, $\nu=0.005$} \end{subfigure}
    \hfill
    \begin{subfigure}{0.32\textwidth} \centering \includegraphics[width=\textwidth]{Images/pstd_snapshots/experiment_5_order/nodal_error_vs_monolithic_order.png} \caption{Pulse, $\gamma=0$, $\nu=0$} \end{subfigure} \\
    \vspace{0.5cm}
    \begin{subfigure}{0.32\textwidth} \centering \includegraphics[width=\textwidth]{Images/pstd_snapshots/experiment_2_order/nodal_error_vs_monolithic_order.png} \caption{Non-smooth, $\gamma=0$, $\nu=0$} \end{subfigure}
    \hfill
    \begin{subfigure}{0.32\textwidth} \centering \includegraphics[width=\textwidth]{Images/pstd_snapshots/experiment_4_order/nodal_error_vs_monolithic_order.png} \caption{Non-smooth, $\gamma=0.5$, $\nu=0.005$} \end{subfigure}
    \hfill
    \begin{subfigure}{0.32\textwidth} \centering \includegraphics[width=\textwidth]{Images/pstd_snapshots/experiment_6_order/nodal_error_vs_monolithic_order.png} \caption{Pulse, $\gamma=0$, $\nu=0$} \end{subfigure}
