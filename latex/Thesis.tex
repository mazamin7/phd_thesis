...
By taking the difference between the fully coupled continuous physics and the locally decoupled Neumann physics, the matrix $C_{\mathrm{res}}$ natively acts as a discrete approximation of the continuous singular distribution
\[
[u]\delta_\Gamma'.
\]
Consequently, applying this residual matrix to the state variables numerically reconstructs the exact localized interface forces.
