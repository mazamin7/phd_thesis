...
This appendix derives the closed-form expressions of the matrices \(S_m\) and \(T_m\), respectively introduced in Chapter 2, associated with the exact time integration of the modal ordinary differential equations. For convenience, we recall their definitions:
\begin{equation*}
S_m=e^{A_m\Delta t},
\end{equation*}
\begin{equation*}
