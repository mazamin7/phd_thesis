...
\midrule
1 & 4.62e-05 & 4.18e-05 & 4.07e-05 & 7.74e-06 & 2.39 & 4.02e-05 & 4.02e-05 & 4.02e-05 & 7.69e-06 & 2.39 \\
2 & 3.66e-03 & 1.80e-03 & 9.45e-04 & 4.32e-04 & 1.13 & 9.07e-05 & 1.26e-04 & 1.68e-04 & 4.61e-05 & 1.87 \\
3 & 7.98e-05 & 8.54e-05 & 8.67e-05 & 3.43e-05 & 1.34 & 8.69e-05 & 8.69e-05 & 8.69e-05 & 3.43e-05 & 1.34 \\
4 & 4.77e-05 & 7.38e-05 & 8.19e-05 & 3.37e-05 & 1.28 & 1.07e-04 & 8.99e-05 & 8.54e-05 & 3.46e-05 & 1.31 \\
5 & 3.02e-04 & 1.08e-04 & 8.05e-05 & 7.47e-05 & 0.11 & 7.29e-05 & 7.29e-05 & 7.29e-05 & 7.29e-05 & - \\
6 & 2.34e-02 & 1.62e-02 & 7.61e-03 & 4.06e-03 & 0.91 & 2.78e-04 & 3.93e-04 & 5.46e-04 & 7.23e-04 & -0.41 \\
\bottomrule
\end{tabular}%
}
...
\begin{figure}[H]
    ...
    \begin{subfigure}[t]{0.32\textwidth}
        \vspace{0pt}
        \centering
        \includegraphics[width=\textwidth]{Images/ard_3d/nu4_t04.png}
        \caption{$\nu = 4\cdot 10^{-6}$, $t=0.04$\,s}
    \end{subfigure}
    \hfill
    \begin{subfigure}[t]{0.32\textwidth}
        \vspace{0pt}
    ...
    \begin{subfigure}[t]{0.32\textwidth}
        \vspace{0pt}
        \centering
        \includegraphics[width=\textwidth]{Images/ard_3d/nu4_t08.png}
        \caption{$\nu = 4\cdot 10^{-6}$, $t=0.08$\,s}
    \end{subfigure}
    \hfill
    \begin{subfigure}[t]{0.32\textwidth}
        \vspace{0pt}
    ...
    \begin{subfigure}[t]{0.32\textwidth}
        \vspace{0pt}
        \centering
        \includegraphics[width=\textwidth]{Images/ard_3d/nu4_t12.png}
        \caption{$\nu = 4\cdot 10^{-6}$, $t=0.12$\,s}
    \end{subfigure}
    \hfill
    \begin{subfigure}[t]{0.32\textwidth}
        \vspace{0pt}
    ...
    \caption{3D ARD numerical experiment inside a multi-corridor geometry. The snapshots compare the wave propagation at three different time steps (rows) and three different viscoelastic damping configurations (columns). The solver seamlessly handles the internal boundaries between the three rectangular subdomains.}
