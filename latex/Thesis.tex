...
\begin{equation*}
O(\Delta t) \quad \text{\cite{quarteroni_numerical_2014}}.
\end{equation*}
\end{proposition}
...
\Delta x\to0.
\)
Consequently, the matrix dispersion relation \eqref{eq:matrix_dispersion} converges to the continuous dispersion relation \eqref{eq:dispersion} with the same algebraic or spectral rate as the underlying cosine approximation.
\end{proof}
