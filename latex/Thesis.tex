...
As in the previous experiment, the reference solution is obtained by combining the classical d'Alembert formula with the method of images. The initial triangular profile is extended to an even $2L$-periodic function, $u_0^{\mathrm{ext}}(x)$, yielding the exact solution
\[
u(x,t)
=
\frac12
