...
As in the previous experiment, the reference solution is obtained by applying d'Alembert's formula to the even $2L$-periodic extension of the initial data \cite[Sec.~4.2]{Olver2014}. The initial triangular profile is extended to an even $2L$-periodic function, $u_0^{\mathrm{ext}}(x)$, yielding the exact solution
\[
u(x,t)
=
\frac12
