...
u_0^{\mathrm{ext}}(x+ct).
\]
Equivalently, this construction can be interpreted through the method of images as an infinite sequence of virtual reflected sources \cite[Chap.~3]{Strauss2009}. These image sources are located at
\[
x=2mL\pm\mu,
\qquad
m\in\mathbb Z,
...
u_0^{\mathrm{ext}}(x+ct).
\]
Equivalently, this construction can be interpreted through the method of images as an infinite sequence of virtual reflected sources \cite[Chap.~3]{Strauss2009} located at
\[
x=2mL\pm\mu,
\qquad
m\in\mathbb Z,
