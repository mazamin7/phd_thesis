...
for exp_idx = 1:6
    ...
    fprintf('\n=======================================================\n');
    fprintf('Running Experiment %d: %s\n', exp_idx, experiment);
    fprintf('=======================================================\n');
    ...
    eocNodal = log(errNodal(1:end-1)./errNodal(2:end))/log(2);
    ...
    disp(table( ...
        ...
        [NaN; eocNodal(:)], ...
        'VariableNames', ...
        {'N','Nodal Error vs Monolithic','EOC'}))
    ...
    loglog(dxVec,errNodal,'o-','LineWidth',2,...
        'MarkerSize',8,...
        'DisplayName','Measured');
    hold on

    ref = errNodal(1)*(dxVec/dxVec(1)).^2;
    ...
    title(sprintf('Domain Decomposition Error (Exp %d)', exp_idx))
