...
for j = 1:length(orders)
    ...
    for i = 1:length(N_array)
        ...
        % Run Exponential Euler
        [x_grid, t_grid, ~, ~, u_ard, ~, ~, ~, ~] = ard_solver_no_splitting( ...
            u0_fun, v0_fun, f_fun, ...
...
title('Spatial Convergence of Exponential Euler (Exp 4)');
legend('Location', 'southeast');

saveFolder = 'snapshots/convergence_exp_euler';
